        ...
        .basicinfo
          b-card(
            ...
            .row
              ...
              .col-xs-12.col-sm-12.col-md-6
                small.text-muted
                  translate Ishlatilgan
                h4(v-for="area in reservoir.installed_to_area")
                  span.areatag {{ area.name }}

              .col-xs-12.col-sm-12.col-md-6
                small.text-muted
                  translate Yaratilgan sanasi
                h4 {{ reservoir.created_date | moment('timezone', 'Asia/Tashkent').format('DD/MM/YYYY') }}
                ...
                .col-xs-8.col-sm-8.col-md-9.col-lg-10
                  span {{ reservoirNote.content }}
                    small.text-muted.clear.text-ellipsis
                      |
                      | {{ reservoirNote.created_date | moment('timezone', 'Asia/Tashkent').format('DD/MM/YYYY') }}
