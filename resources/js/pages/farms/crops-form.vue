...
.crops-form(v-if="loading === false")
    .modal-header
      span.h4.font-bold(v-if="crop.uid")
        translate Ekinni o'zgartirish
      span.h4.font-bold(v-else)
        translate Yangi ekin partiyasini qo'shish
    .modal-body
      p.text-muted
        translate Ekin partiyasi - bu bir vaqtning o'zida bajarilgan ekinlar miqdoridir.
      b-form(@submit.prevent="validateBeforeSubmit")
        .line.line-dashed.b-b.line-lg
        .form-group
          label.control-label
            translate Ushbu hosil partiyasining faoliyat turini tanlang
          .form-row
          ...
          .col-6
            .form-group
              ...
              select.form-control#plant_type(v-validate="'required'" :class="{'input': true, 'text-danger': errors.has('plant type') }" v-model="crop.plant_type" name="plant type" v-on:change="onChange")
                option(value="") - ekin turini tanlang -
          ...
          .col-6
            .form-group
              ...
              select.form-control#crop-variety(v-validate="'required'" :class="{'input': true, 'text-danger': errors.has('crop variety') }" v-model="crop.name" name="crop variety")
                option(value="") - ekin navini tanlang -
        ...
        .row
          .col-6
            .form-group
              label.control-label Konteyner miqdori
          ...
          .col-6
            .form-group
              label.control-label Konteyner turi
