...
.areas-form
    .modal-header
      span.h4.font-bold(v-if="area.uid")
        translate Maydonni o'zgartirish
      span.h4.font-bold(v-else)
        translate Yangi Maydon qo'shish
    .modal-body
      p.text-muted
        ...
        .form-row
          ...
          .col-xs-6
            .form-group
              label#label-location(for="location") Joylashuv turi
        ...
        .form-row
          .col-xs-6
            .form-group
              label#label-reservoir(for="reservoir") Suv manbaini tanlang
              select#reservoir.form-control(
                ...
                option(value = "") Iltimos suv manbaini tanlang
