<template lang="pug">
 .container-fluid.container-intro
    ...
    .row
      .col-xs-12.col-sm-12.col-md-6.offset-md-3.col-lg-4.offset-lg-4
        h3.text-center
          translate Salom! Fermangiz haqida bir oz gapirib bera olasizmi?

    .row
      .col-xs-12.col-sm-12.col-md-6.offset-md-3.col-lg-4.offset-lg-4
        b-form(@submit.prevent="validateBeforeSubmit")
          b-card(
            :title="$gettext('Ferma yaratish')"
          )
            error-message(:message="message.error_message")
            .form-group
              label#label-name(for="name")
                translate Ferma nomi
            ...
            .form-group
              ...
              select.form-control#type(
                ...
                option(value="")
                  translate Iltimos turni tanlang
            ...
            .form-row.form-group
              .col
                ...
                select.form-control#country(
                  ...
                  option(value="")
                    translate Iltimos davlatni tanlang
              ...
              .col
                ...
                span.help-block.text-danger(v-show="errors.has('city')")
                  | {{ errors.first('city') }}
            .form-group
              BtnContinue(:title="$gettext('Davom ettirish')" customClass="float-right")
