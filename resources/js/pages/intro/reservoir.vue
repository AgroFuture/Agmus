...
.container-fluid.container-intro
    ...
    .row
      .col-xs-12.col-sm-12.col-md-6.offset-md-3.col-lg-4.offset-lg-4
        h3.text-center
          translate Ajoyib! Endi fermangiz uchun yangi suv manbasini yarataylik.

    .row
      .col-xs-12.col-sm-12.col-md-6.offset-md-3.col-lg-4.offset-lg-4
        b-card(
          :title="$gettext('Suv manbaini yaratish')"
        )
          ...
          b-form(@submit.prevent="validateBeforeSubmit")
            ...
            .form-group
              ...
              select.form-control#type(
                ...
                option(value="")
                  translate Iltimos Mmanba turini tanlang
            ...
            .form-group(v-if="reservoir.type == 'BUCKET'")
              input#capacity.form-control(
                ...
                :placeholder="$gettext('Hajmi (litr)')"
                name="capacity"
              )
