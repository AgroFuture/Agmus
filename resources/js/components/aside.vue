...
aside#aside
  .brand-image.text-center
    img(src="../../images/logo.png" alt="AGMUS Logo")

  b-nav(vertical="vertical")
    AsideItem(
      :title="$gettext('Boshqaruv paneli')"
