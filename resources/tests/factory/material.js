...
export function filled_material_seed() {
  // Label
  cy.get('label#label-material-type').should('contain', 'Material turini tanlang')
  cy.get('label#label-name').should('contain', 'Nav nomi')
  cy.get('label#label-plant-type').should('contain', 'Osimlik turi')
  cy.get('label#label-produced-by').should('contain', 'Ishlab chiqaruvchi')
  ...
  cy.get('label#label-notes').should('contain', 'Qoshimcha izoh')

  cy.get('button.btn[type=submit]').click()
  cy.get('span.help-block.text-danger').should('contain', 'The name field is required.')
  cy.get('span.help-block.text-danger').should('contain', 'Ishlab chiqaruvchini kiritish kerak .')
...
export function filled_material_agrochemical() {
  ...
  cy.get('label#label-material-type').should('contain', 'Material turini tanlang')
  cy.get('label#label-name').should('contain', 'Name')
  cy.get('label#label-chemical-type').should('contain', 'Kimyoviy turi')
  cy.get('label#label-produced-by').should('contain', 'Ishlab chiqaruvchi')
  cy.get('label#label-quantity').should('contain', 'Miqdori')
  cy.get('label#label-quantity-unit').should('contain', 'Birligi')
  cy.get('label#label-price-per-unit').should('contain', 'Tan narxi')
  cy.get('label#label-expiration-date').should('contain', 'Yaroqlilik muddati')
  cy.get('label#label-notes').should('contain', 'Qoshimcha izoh')
...
export function filled_material_label_crop_support() {
  ...
  // Label
  cy.get('label#label-material-type').should('contain', 'Material turini tanlang')
  cy.get('label#label-name').should('contain', 'Nomi')
  cy.get('label#label-quantity').should('contain', 'Miqdori')
  cy.get('label#label-price-per-unit').should('contain', 'Tan narxi')
  cy.get('label#label-notes').should('contain', 'Qoshimcha izoh')
...
export function filled_material_other() {
  ...
  cy.contains('Save').click()
  cy.get('span.help-block.text-danger').should('contain', 'The name field is required.')
  cy.get('span.help-block.text-danger').should('contain', 'Ishlab chiqaruvchi field is required.')
  cy.get('span.help-block.text-danger').should('contain', 'The quantity field is required.')
  cy.get('span.help-block.text-danger').should('contain', 'The price field is required.')
