export function filled_farm() {
  ...
  cy.get('input#latitude').type('38.858582').should('have.value', '38.858582')
  cy.get('input#longitude').type('65.792160').should('have.value', '65.792160')
  cy.get('select#country').select('Uzbekistan')
  cy.get('input#city').type('Karshi')
