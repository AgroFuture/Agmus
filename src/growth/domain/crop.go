...
func CropStatuses() []CropStatus {
	return []CropStatus{
		{Code: CropActive, Label: "Aktiv"},
		{Code: CropArchived, Label: "Arxivlangan"},
	}
}
...
func CropTypes() []CropType {
	return []CropType{
		{Code: CropTypeSeeding, Label: "Ko'chat"},
		{Code: CropTypeGrowing, Label: "O'sib borayotgan"},
	}
}
...
func HarvestTypes() []HarvestType {
	return []HarvestType{
		{Code: HarvestTypeAll, Label: "To'liq"},
		{Code: HarvestTypePartial, Label: "Qisman"},
	}
}
